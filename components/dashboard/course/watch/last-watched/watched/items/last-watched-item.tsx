...
export default function LastWatchedItem({ user, item }: LastWatchedItemProps) {
  ...
  if (loading) {
    return (
      <div className="bg-gray-100 dark:bg-gray-800 rounded-md animate-pulse w-[13rem] h-[7.6rem]"></div>
    );
  }
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="flex flex-col justify-between rounded-md bg-gray-100 dark:bg-gray-800 overflow-hidden w-[13rem] h-[7.6rem]"
        style={{
